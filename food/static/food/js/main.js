...
fetch('/food/api/get_orders_received_today/')
  ...
  .then(data => {
    ...
    if (totalOrders === 0) {
      ordersContainer.innerHTML = '<h2 style="color: rgb(20, 23, 216);">Total orders today: 0</h2>';
    } else {
      ...
      ordersContainer.innerHTML = `<h2 style="color: rgb(20, 23, 216)">Total orders today: ${totalOrders} </h2> <br> <h2 style="color: rgb(20, 23, 216);"> Total bill today: ${totalBill.toFixed(2)} / 800</h2>` + ordersHtml.join('');
